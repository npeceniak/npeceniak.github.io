...
VpaidVideoPlayer.prototype.startAd = function() {
  ...
  // add a test click thru button                                  
  var clickThru = document.createElement('input');
  clickThru.setAttribute('type', 'button');
  clickThru.setAttribute('value', 'ClickThru');
  clickThru.addEventListener('click', this.overlayOnClick_.bind(this), false);
